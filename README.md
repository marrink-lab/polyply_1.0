...
- (Jan 18, 23') **Towards whole cell simulations with polyply.** In [a perspective on simulating complete cells](https://www.frontiersin.org/articles/10.3389/fchem.2023.1106495/full) using the Martini force field Stevens *et al.* utilize polyply to reconstruct the full 0.5 Mio bp genome of the Syn3A minimal cell. This impressive task is a good example of the power of the upcoming DNA implementaion into polyply and the role of polyply in the Martini Ecosystem.
