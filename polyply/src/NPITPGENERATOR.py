...
In the sample NP, what NP was made? 

Ligand type 1 - 1MIMI.gro
Ligand type 2 - 2NITL.gro

Useful Links:
------------
https://parmed.github.io/ParmEd/html/gromacs.html
...
MartiniUniverse = mda.Universe("/home/sang/Desktop/GIT/Martini3-small-molecules/models/gros/2NITL.gro")

MartiniItp = mda.Universe('/home/sang/Desktop/GIT/Martini3-small-molecules/models/itps/cog-mono/2NITL_cog.itp', 
                          topology_format='ITP', infer_system=True)

# To successfully read from the topology file, a single topology molecule topology file needs to be made first 
MartiniAltItp = GromacsTopologyFile('/home/sang/Desktop/GIT/Martini3-small-molecules/models/itps/cog-mono/2NITL_cog.top')
...
# Loop over the bonds
for bond in D:
    print(bond.atom1.name, bond.atom2.name, bond.atom1.atom_type.name, bond.atom2.atom_type.name, bond.atom1.idx, bond.atom2.idx,  bond.atom2.atom_type.name, bond.type.k, bond.type.idx, bond.type.req)
    print(bond)
#for type in 
...
for improper in MartiniAltItp.impropers:
    print(improper.atom1.idx, improper.atom2.idx, improper.atom3.idx, improper.atom4.idx, improper.type.psi_k, improper.type.psi_eq, improper.funct)
...
ResidueProperties = ['atoms', 'residues', 'bonds', 'angles', 'dihedrals', 'rb_torsions', 'impropers']
...
MartiniAltItp = GromacsTopologyFile('/home/sang/Desktop/GIT/Martini3-small-molecules/models/itps/cog-mono/1MIMI_cog.top')
MartiniAltItp.__dict__
#print ('[ bonds ]')
#print('; i  j  func')
#print('; ligand-1')
...
for bond in D:
    ...
    print(bond.funct, bond.atom1.name, bond.atom2.name, bond.atom1.atom_type.name, bond.atom2.atom_type.name, bond.atom1.idx, bond.atom2.idx,  bond.atom2.atom_type.name, bond.type.k, bond.type.idx, bond.type.req)
...
top = TOP("/home/sang/Desktop/GIT/Martini3-small-molecules/models/itps/cog-mono/1MIMI_cog.top")
top
...
# To successfully read from the topology file, a single topology molecule topology file needs to be made first 
MartiniAltItpII = GromacsTopologyFile('/home/sang/Desktop/GIT/Martini3-small-molecules/models/itps/cog-mono/2NITL_cog.top')
# Read the NP Pandas 
...
class NPItpWriter():
    ...
    def LigandTopGenerator(LigandName, PandaTable = None, TopFile = None):
        ...
        StripedNPCore = StripedNP[StripedNP['name'] == LigandName] # Pick out only the aoms of the core
...
ReturnPandasITP("/home/sang/Desktop/GIT/Martini3-small-molecules/models/itps/cog-mono/DMBZQ_cog.itp")
...
def GenerateNPITP(BeadDict, BeadMass, ItpPath):
    ...
    MartiniItp = mda.Universe(ItpPath, 
                          topology_format='ITP', infer_system=True)
    ...
    BeadDict = {'SN3a': 'N1', # index 1  
                'SC4' : 'R2', # index 2 
                'TC5' : 'R3', # index 3 
                'TC5' : 'R4'} # index 4 
    
    BeadMass = {'SN3a' : 100.00,  # index 1 
                'SC4' : 100.00,  # index 2 
                'TC5' : 100.00, # index 3 
                'TC5' : 100.00} # index 4 
