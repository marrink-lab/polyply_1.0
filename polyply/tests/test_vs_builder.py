...
@pytest.mark.parametrize('vs_type, interaction, positions, result', (
 ...
 #  # vs31
    ("virtual_sites3",
     Interaction(atoms=[4, 1, 2, 3], parameters=["1", "0.223", "0.865"], meta={}),
 ...
 #  # vs32
   ("virtual_sites3",
    Interaction(atoms=[4, 1, 2, 3], parameters=["2", "0.223", "0.865"], meta={}),
    {1: np.array([4.717, 0.333, 4.974]), 2: np.array([4.983, -0.028, 5.098]),
     3: np.array([5.307, -0.324, 4.951])},
 ...
 #  # vs33
   ("virtual_sites3",
    Interaction(atoms=[4, 1, 2, 3], parameters=["3", "150", "0.22"], meta={}),
    {1: np.array([4.717, 0.333, 4.974]), 2: np.array([4.983, -0.028, 5.098]),
     3: np.array([5.307, -0.324, 4.951])},
 ...
 #  # vs34
    ("virtual_sites3",
     Interaction(atoms=[4, 1, 2, 3], parameters=["4", "0.2", "0.3", "1.5"], meta={}),
     {1: np.array([4.717, 0.333, 4.974]), 2: np.array([4.983, -0.028, 5.098]),
      3: np.array([5.307, -0.324, 4.951])},
 ...
 #  # vs4
   ("virtual_sites4",
    Interaction(atoms=[5, 1, 2, 3, 4], parameters=["2", "0.22", "0.45", "0.6"], meta={}),
...
def test_IOError():
    ...
    with pytest.raises(IOError):
         construct_vs("virtual_sites4", Interaction(atoms=[], parameters=["1"], meta={}), {})
